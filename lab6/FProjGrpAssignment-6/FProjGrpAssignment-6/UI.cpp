	...
	while (choice != "3") { // ask the use whether they want to test task 1 or task 3
		...
		if (choice == "1") {
			...
			vector<string> firstNames = {
				...
				"Sophia", "Isabella", "Mia", "Jackson", "Aiden",
				"Lucas", "Luna", "Elijah", "Harper", "Evelyn",
				"Grace", "Emily", "Michael", "James", "Amelia",
				"Benjamin", "Ella", "William", "Scarlett", "Abigail",
				"Alexander", "Avery", "Ethan", "Mila", "Lily",
				"Aria", "Hannah", "Ella", "Logan", "Sofia",
				"Layla", "Oliver", "Chloe", "Daniel", "Madison",
				"Eva", "Emma", "Sebastian", "Nora", "Aiden",
				"Isabella", "Liam", "Hazel", "Emily", "Mason"
			};
			vector<string> lastNames = {
				"Smith", "Johnson", "Williams", "Jones", "Brown",
				"Davis", "Miller", "Wilson", "Taylor", "Clark",
				"White", "Allen", "Hall", "Lewis", "Scott",
				"Young", "King", "Wright", "Green", "Lee",
				"Walker", "Edwards", "Collins", "Cook", "Bailey",
				"Parker", "Bell", "Turner", "Carter", "Gomez",
				"Gonzalez", "Hill", "Mitchell", "Roberts", "Phillips",
				"Murphy", "Howard", "Cruz", "Rogers", "Gray",
				"Bennett", "Flores", "Ramos", "Perez", "Stewart",
				"Watson", "Sullivan", "Morgan", "Ward", "Cooper"
			};
